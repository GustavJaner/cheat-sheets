...
## ADD
Add files to Stage them for Commit
```
$ git add .               # Stage all modified files
$ git add *               # Stage all modified files
...
## FETCH
Update All REMOTE Branches of the local repo from Remote Origin
```
...
$ git rebase dev   # Rebase to Fast-Forward master to dev
